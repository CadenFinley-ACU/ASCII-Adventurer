...
public class MountainTopDungeon extends Dungeon {
    ...
    private static List<String> items = new ArrayList<>(List.of("great sword", "knight armor", "health potion"));
    ...
    public static void fresh() { //fresh
        items = new ArrayList<>(List.of("great sword", "knight armor", "health potion"));
        foundItemRooms = 0;
