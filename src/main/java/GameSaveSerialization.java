...
public class GameSaveSerialization {
    ...
    public static void saveGame() {
        ...
        writeSeparator(filePath);
        writeMatrix(Main.MeadowDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DarkForestDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.MountainCaveDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.MountainTopDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DesertOasisDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DesertPlainsDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DesertPyramidDungeon.map, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.OceanKingdomDungeon.map, filePath);
        writeSeparator(filePath);
        ...
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MeadowDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MeadowDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DarkForestDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DarkForestDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MountainCaveDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MountainCaveDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MountainTopDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MountainTopDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertOasisDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertOasisDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertPlainsDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertPlainsDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertPyramidDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertPyramidDungeon.visited), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.OceanKingdomDungeon.completed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.OceanKingdomDungeon.visited), filePath);
        writeSeparator(filePath);
        writeMatrix(Main.MeadowDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DarkForestDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.MountainCaveDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.MountainTopDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DesertOasisDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DesertPlainsDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.DesertPyramidDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeMatrix(Main.OceanKingdomDungeon.roomsBeenTo, filePath);
        writeSeparator(filePath);
        writeList(Main.MeadowDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.DarkForestDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.MountainCaveDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.MountainTopDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.DesertOasisDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.DesertPlainsDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.DesertPyramidDungeon.items, filePath);
        writeSeparator(filePath);
        writeList(Main.OceanKingdomDungeon.items, filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MeadowDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DarkForestDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MountainCaveDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.MountainTopDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertOasisDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertPlainsDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.DesertPyramidDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
        writeValue(String.valueOf(Main.OceanKingdomDungeon.mapRevealed), filePath);
        writeSeparator(filePath);
    ...
    public static void loadGameSave() throws InterruptedException {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(runtimePath))) {
            try {
                ...
                buffer = reader.readLine();
                Main.MeadowDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.DarkForestDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.MountainCaveDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.MountainTopDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.DesertOasisDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.DesertPlainsDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.DesertPyramidDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
                Main.OceanKingdomDungeon.map = readMatrix(reader);
                buffer = reader.readLine();
