...
public class OceanKingdomDungeon extends Dungeon {
    ...
    private static void startRooms() throws InterruptedException {
        ...
        availableMove = null;
        Main.screenRefresh();
        DungeonGenerator.drawRoom(oceanKingdomDungeon, roomsBeenTo, currentPlayerPosition[0], currentPlayerPosition[1], numberOfEnemies);
    ...
    private static void handleDirectionsAndCommands() throws InterruptedException {
        Main.screenRefresh();
        DungeonGenerator.drawRoom(oceanKingdomDungeon, roomsBeenTo, currentPlayerPosition[0], currentPlayerPosition[1], 0);
